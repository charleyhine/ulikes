class ImportData < ActiveRecord::Migration
  def self.up
		...
		MessageState.create( :name => 'Received' )
		MessageState.create( :name => 'Unprocessed' )
		MessageState.create( :name => 'Sent' )
		MessageState.create( :name => 'Processing' )
		MessageState.create( :name => 'SendError' )

		ConversationState.create( :id => 1, :name => 'OPEN' )
		ConversationState.create( :id => 2, :name => 'CLOSED' )
  end
